////////////// VARS //////////////
	// the main siet
        ...
        Game = function(canvas){
            ...
            running : false, //false first because duh
            oNext : false, //track what key was bitched on
            score : 0, // duh
            timer : 200, // x sexonds til you diiiieee
            stank : 10, //life is stanky
            dir : { //para alam mo kung saan sya papunta
                up: false,
                down: false,
                left: false
            },
            ...
            init : function(){
                ...
                //peed
                _.bathroom.prototype = {
                    music : new Audio('sounds/bgmusic.mp3'),
                    xPos : 0,
                    xSpeed: _.def.speed + 10,
                },
                _.bathroom.music.loop = true;
                ...
                _.shit.prototype  = {
                    ...
                    sprite : { //shit's sprite bg position strings because i'm a lazy fuck
                        steady : {
                            H : '0px -200px',
                            M : '-200px -200px',
                            L : '-400px -200px',
                    ...
                    curr : function(action,status) { //return appropro sprite bg coordinates

                        // currShit : null, // Walk mood
                        // currJumpShit : null, // Jump mood
                        // currDownShit : null, // Falling down mood
                        // currSteadyShit : null, // not moving bitch
